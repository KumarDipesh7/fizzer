...
export default function About() {
  return (
    ...
    >
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-16 px-6 lg:grid-cols-[480px_1fr]">

        {/* LEFT IMAGE */}

        <div className="relative mx-auto w-full max-w-[480px] overflow-hidden border border-white/10 bg-[#1b1717]">
        ...
        <div className="max-w-3xl">
          ...
          <div className="mt-12 grid grid-cols-3 border-t border-white/10 pt-8">

            <div>
              <h3 className="text-4xl font-black text-white">100K+</h3>
